...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = selectRandomColor;
...
function init() {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["b" /* createLights */])();
...
function createAsteroids(){
  ...
  for (var i = 0; i < 5; i++) {
    asteroid = new __WEBPACK_IMPORTED_MODULE_8__asteroid__["a" /* default */]();

    asteroid.mesh.scale.set(.90,.90,.90);
    asteroid.mesh.position.y = 10 + (Math.random()*180);
    asteroid.mesh.position.x = 200 + (i * Math.random()*200);
...
let loop = function loop(){
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["d" /* overheadLight */].intensity = 0.3;
  ...
  positionComparison = spaceship.mesh.position.sub(asteroid.mesh.position);
  ...
  if (Math.floor(distanceBetweenX) < 23 && distanceBetweenY < 10) {
    ...
    handleCrash();
    // spaceship.mesh.position.y -= 100.9;
  }
  ...
  // asteroid.mesh.position.y += 0.5 * Math.sin(asteroid.mesh.position.x/10); // constants are just setting a useful range
  ...
  for (var i = 0; i < asteroidsArray.length; i++) {
    ...
    singleAst.mesh.position.x -= 1.5;
    // singleAst.mesh.rotation.y += .01;
    // singleAst.mesh.rotation.z += .01;

    if (singleAst.mesh.position.x <= -200) {
      singleAst.mesh.position.x = 230 + Math.random()*20;
      // singleAst.mesh.position.y += Math.random()*10;
    }
  }
...
function updateAsteroids(a) {
  ...
  if (a.mesh.position.x <= -200) {
    ...
    // a.mesh.position.y += Math.random()*10;
  }
}

function handleCrash() {
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["d" /* overheadLight */].intensity = 20;
  Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* selectRandomColor */])();
  // console.log(currentColor);
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["a" /* ambientLight */].color.setHex( __WEBPACK_IMPORTED_MODULE_0__util__["b" /* currentColor */] );
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["c" /* hemisphereLight */].color.setHex( __WEBPACK_IMPORTED_MODULE_0__util__["b" /* currentColor */] );
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["d" /* overheadLight */].color.setHex( __WEBPACK_IMPORTED_MODULE_0__util__["b" /* currentColor */] );
  __WEBPACK_IMPORTED_MODULE_1__three_util_scene_util__["d" /* scene */].fog.color.setHex( __WEBPACK_IMPORTED_MODULE_0__util__["b" /* currentColor */] );
}
