...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__three_util_scene_util__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__game__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__planet__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ship__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__sky__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__moon__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__asteroid__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__asteroid_sky__ = __webpack_require__(13);
...
/*--------------------------AsteroidSky-------------------------------------*/
const asteroidSky = new __WEBPACK_IMPORTED_MODULE_9__asteroid_sky__["a" /* default */]();
function createAsteroids(){
  asteroidSky.mesh.position.y = -700;
  // asteroidSky.mesh.position.z = -300;
  __WEBPACK_IMPORTED_MODULE_1__three_util_scene_util__["d" /* scene */].add(asteroidSky.mesh);
}
/*--------------------------Ship-------------------------------------*/
...
let loop = function loop(){
  ...
  asteroidSky.mesh.rotation.z += .008*speedup;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__orbit__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scene_util__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util__ = __webpack_require__(0);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__asteroid__ = __webpack_require__(7);
...
const SingleAsteroid = function(){
  ...
  let geom = new THREE.BoxGeometry(10,10,10,3,3,3);
  let mat = new THREE.MeshBasicMaterial({wireframe:true,
    color:__WEBPACK_IMPORTED_MODULE_0__util__["a" /* Colors */].pinkNeon,
  });

  // duplicate the geometry a random number of times
  let nBlocs = 1; // number of asteroids in cluster
...
const AllAsteroids = function(){
  ...
  // we need to place them according to a uniform angle
  let stepAngle = Math.PI*2 / this.nAsteroids;

  // create asteroid clusters
  for(var i = 0; i<this.nAsteroids; i++){
    let asteroid = new SingleAsteroid();

    // set the rotation and the position of each asteroid;
    let a = stepAngle*i; // this is the final angle of the asteroid
    let h = 750 + Math.random()*200; // this is the distance between the center of the axis and the asteroid itself
    ...
    let s = 0.5+Math.random()*0.; // first num = inner radius // sec = width of doughnut
    // let s = 1; // first num = inner radius // sec = width of doughnut
    asteroid.mesh.scale.set(s,s,0);
...
/* harmony default export */ __webpack_exports__["a"] = (AllAsteroids);
