...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = selectRandomColor;
...
let loop = function loop(){
  ...
  if (Math.floor(distanceBetweenX) < 23 && distanceBetweenY < 10) {
    ...
    // TweenMax.to(camera.rotation, speed, {x:Math.random()*12, y:Math.random()*12});
    handleCrash();
...
function handleCrash() {
  let currentColor = Object(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* selectRandomColor */])();
  console.log(currentColor);
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["a" /* ambientLight */].color.setHex( currentColor );
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["c" /* hemisphereLight */].color.setHex( currentColor );
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["d" /* overheadLight */].color.setHex( currentColor );
  __WEBPACK_IMPORTED_MODULE_1__three_util_scene_util__["d" /* scene */].fog.color.setHex( currentColor );
}
