...
let loop = function loop(){
  ...
  __WEBPACK_IMPORTED_MODULE_2__three_util_lights_util__["d" /* overheadLight */].intensity = 0.9;
  ...
  if (asteroidsArray.length) {
    setInterval(asteroidsArray.push(new __WEBPACK_IMPORTED_MODULE_8__asteroid__["a" /* default */]()), 5000);
  } else {
