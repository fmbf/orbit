...
function createScene() {
  ...
  scene.fog = new THREE.Fog(__WEBPACK_IMPORTED_MODULE_4__util__["a" /* Colors */].light, 100, 950);
...
function createLights() {
  ...
  hemisphereLight = new THREE.HemisphereLight(__WEBPACK_IMPORTED_MODULE_4__util__["a" /* Colors */].light, 0x000000, .9)


  // ambientLight = new THREE.AmbientLight(0xdc8874, .5);
  ambientLight = new THREE.AmbientLight(__WEBPACK_IMPORTED_MODULE_4__util__["a" /* Colors */].light, .5);
