...
let loop = function loop(){
  ...
  document.getElementById("time").innerHTML = `${scoreCounter}`;
...
function handleCrash(hitAsteroid) {
  ...
  // document.getElementById("playerHP").style.fontSize = "30px";
  ...
  document.getElementById("hp-bar").style.backgroundColor = "salmon";
