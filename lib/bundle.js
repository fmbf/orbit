...
function createAsteroids(){
  ...
  for (var i = 0; i < 5; i++) {
    ...
    asteroid.mesh.scale.set(.90 + i/5, .90 + i/5,.90);
...
let loop = function loop(){
  // document.getElementById("playerHP").style.fontSize = "20px";
...
function handleCrash(hitAsteroid) {
  ...
  document.getElementById("playerHP").style.fontSize = "40px";
  document.getElementById("playerHP").innerHTML = `${spaceship.health}`;
  setTimeout(() => document.getElementById("playerHP").style.fontSize = "20px", 300)
