...
let loop = function loop(){
  ...
  // console.log('asteroid', asteroid.mesh.position);

  let crashrangeX = 10;
  let crashrangeY = 10;

  if (Math.floor(spaceship.mesh.position.x) === Math.floor(asteroid.mesh.position.x) &&
      Math.floor(spaceship.mesh.position.y) === Math.floor(asteroid.mesh.position.y)) {
