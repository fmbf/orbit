...
function updateCoin() {
  ...
  // coin.mesh.position.x += speedup;
  coin.mesh.position.y += Math.sin(coin.mesh.position.x * 5)*0.5;
  coin.mesh.rotation.y += .08;
  coin.mesh.rotation.z += .04;
...
class Coin {
  constructor() {
    ...
    this.mat = new THREE.MeshBasicMaterial({wireframe:true,
      color: __WEBPACK_IMPORTED_MODULE_0__util__["a" /* Colors */].mustard,
      // shading: THREE.FlatShading,
      // transparent:true,
      // opacity:.9,
    });
