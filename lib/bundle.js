...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__planet__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ship__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sky__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__moon__ = __webpack_require__(8);
...
function createScene() {
  ...
  // same color as background color used in the style sheet
  scene.fog = new THREE.Fog(__WEBPACK_IMPORTED_MODULE_5__util__["a" /* Colors */].light, 100, 950);
...
function createLights() {
  ...
  hemisphereLight = new THREE.HemisphereLight(__WEBPACK_IMPORTED_MODULE_5__util__["a" /* Colors */].light, 0x000000, .9)


  ambientLight = new THREE.AmbientLight(__WEBPACK_IMPORTED_MODULE_5__util__["a" /* Colors */].light, .5);

  // A directional light shines from a specific direction.
  // It acts like the sun, that means that all the rays produced are parallel.
  shadowLight = new THREE.DirectionalLight(0xffffff, .9); // // NOTE: flash this on impact!
...
const planet = new __WEBPACK_IMPORTED_MODULE_0__planet__["a" /* default */]();
const createPlanet = function createPlanet(){
  planet.mesh.position.y = -600;
  scene.add(planet.mesh);
};

const sky = new __WEBPACK_IMPORTED_MODULE_2__sky__["a" /* default */]();
function createSky(){
...
const spaceship = new __WEBPACK_IMPORTED_MODULE_1__ship__["a" /* default */]();
function createShip(){
...
const moon = new __WEBPACK_IMPORTED_MODULE_3__moon__["a" /* default */]();
const moon2 = new __WEBPACK_IMPORTED_MODULE_3__moon__["a" /* default */]();
...
const enemy = new __WEBPACK_IMPORTED_MODULE_4__enemy__["a" /* default */]();
...
const Planet = function Planet(){
  ...
  // var mat = new THREE.MeshBasicMaterial({wireframe:false,
    // color:Colors.light,
    color:__WEBPACK_IMPORTED_MODULE_0__util__["a" /* Colors */].light,
    transparent:true,
