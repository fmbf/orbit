...
function handleCursorUpdate(event) {
  ...
  var tx = (-1 + (event.clientX / __WEBPACK_IMPORTED_MODULE_1__three_util_scene_util__["f" /* windowWidth */])*2);
  // inverse because the 2D y-axis goes the opposite direction of the 3D y-axis
  var ty = 1 - (event.clientY / __WEBPACK_IMPORTED_MODULE_1__three_util_scene_util__["e" /* windowHeight */])*2;
